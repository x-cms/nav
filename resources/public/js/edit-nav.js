// Init
let ManageNav = function () {
    "use strict";

    let $body = $('body');

    let $_TARGET = $('.nestable-nav');

    let $_UPDATE_TO = $('#nav_structure');
    ...
    let handleItems = function () {
        ...
        let MENU_NESTABLE_TEMPLATES = {
            listGroup: $('#navs_template_list_group').html(),
            listItem: $('#navs_template_list_item').html(),
        };
        ...
        let handleAddNew = function () {
             ...
             */
            $body.on('click', '.box-link-navs .add-item', function (event) {
                event.preventDefault();
                let $box = $(this).closest('.box-link-navs');
        ...
        let handleRemove = function () {
             ...
             * Remove node
             */
            $body.on('click', '.dd-item .item-details .btn-danger', function (event) {
                event.preventDefault();
